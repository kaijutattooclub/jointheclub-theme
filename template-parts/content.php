...
?>
    <div id="post-<?php the_ID();?>" class="mx-4 rounded overflow-hidden flex flex-col">
        ...
        <div class="relative">
            ...
            <a href="<?php the_permalink();?>"
                class="text-2xl font-semibold inline-block transition duration-500 ease-in-out mb-2 hover:text-primary"><h1 class="text-2xl mt-2">
                <?php the_title();?></h1></a>
            <p class="text-base ">
                <?php the_excerpt(); ?>
            </p>
        <div class="text-sm font-regular text-[--stroke] flex flex-col md:flex-row mt-8">
            ...
            <a href="<?php the_permalink();?>"
                class="bg-primary p-4 text-[--stroke] absolute z-10 text-xs bottom-0 right-0 px-6 m-2 mt-4 py-2 hover:bg-primary-600 transition duration-500 ease-in-out sm:flex items-center"><span
