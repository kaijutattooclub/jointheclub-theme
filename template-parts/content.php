    ...
    <div id="post-<?php the_ID();?>" class="mx-4 rounded overflow-hidden flex flex-col">
      ...
      <div class="text-sm font-regular text-[--stroke] flex flex-col md:flex-row mt-8">
        ...
        ?>
          ...
          <a href="<?php the_permalink();?>"
              class="bg-primary p-4 text-[--stroke] absolute z-10 text-xs bottom-0 right-0 px-6 m-2 mt-4 py-2 hover:bg-primary-600 transition duration-500 ease-in-out sm:flex items-center">
