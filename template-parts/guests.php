    ...
    if ($q->have_posts()) :
        while ($q->have_posts()) : $q->the_post();
            ...
            <div class="w-full md:w-1/2 card rounded-xl m-4 mb-[4rem] p-4 bg-base-200">
                ...
                array_push($previous_guest_artists, $start_date."-".$to_date." <a href='".$instagram_url."' target='_blank' class='link link-hover text-primary strong bold font-bold'>".$artist_name.", @".$instagram_username."</a>");
            }
        endwhile;
        wp_reset_postdata();
    else :
